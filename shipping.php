...
<html class="no-js" lang="en" dir="ltr">
  <head>
    ...
    <link
      rel="canonical"
      href="https://peachmode.com/policies/shipping-policy"
      <link
      rel="shortcut icon"
      href="img/1.png"
    />
    ...
    <meta
      property="og:url"
      content="https://peachmode.com/policies/shipping-policy"
    />
    ...
    <script id="__st">
      var __st = {
        a: 63748341981,
        offset: 19800,
        reqid: "51b6ca39-66b1-4e48-98f3-c14c24134bb4",
        pageurl: "peachmode.com\/policies\/shipping-policy",
        t: "prospect",
        u: "96369f9e95b5",
      };
    </script>
      ...
      <div class="shopify-policy__container">
        ...
        <div class="shopify-policy__body">
          <div class="rte">
            ...
            <p align="justify">
              Kalaajee is commited to deliver your order accurately in good
              condition and always on time. We believe in express shipping and
              most of your order is shipped within 24 hours once the order is
              placed except on weekend or on public holidays. We deliver to all
              the locations across the world.
            </p>
            <h3>Shipping Restriction</h3>
            <p align="justify">
              Any items notified by delivery company to be restricted and/or
              banned and/or prohibited from time to time(including but not
              limited to animals, bullion, currency, bearer from negotiable
              instruments, precious metals and stones, firearms or parts thereof
              and ammunition, human remains, pornography and illegal
              narcotics/drugs).
            </p>
            <h3>Important Information</h3>
            <p align="justify">
              Order cut-off times are provided as guidelines only, and do not
              take into account possible delays caused by payment authorization.
              We aim to dispatch all orders as soon as the product is ready and
              within time shown on the product page. However, a delay of 72
              hours is possible from the designer / manufacturer in case of
              unforeseen circumstances. Estimated delivery times are to be used
              as a guide only and commence from the date of dispatch. We are not
              responsible for any delays caused by destination customs clearance
              processes. We are unable to redirect orders once items have been
              dispatched. <br />
            </p>
            <h3>When do we Deliver</h3>
            <p align="justify">
              All domestic orders are shipped by delivery company between 9am -
              6pm, Monday to Saturday. It takes maximum of 7 days for national
              shipping. If there is further delay kindly contact us on
              contact@peachmode.com and we will try and delivery the products as
              soon as possible.<br />
            </p>
            <h3>Shipping in India</h3>
            <p align="justify">
              Shipping in India is free of charge. This is to maintain the
              service level and provide your product on time. We use Delhivery
              and Speed Post services to deliver in India. <br />
            </p>
            <h3>International Shipping</h3>
            <p align="justify">
              Peachmode delivers globally and assures that the best possible
              courier agencies is used to deliver your product. International
              Shipping cost minimum Rs. 1000 for the first product, after which
              Rs. 400 is added per product. Many a times selling price includes
              shipping charges for a country. Please see the final charges at
              the time of checkout.<br />
            </p>
            <h3>Insurance</h3>
            <p align="justify">
              Peachmode insures each purchase during the time it is in transit
              until it is delivered to you. We require a signature for any goods
              delivered, at which point responsibility for your purchased goods
              passes to you. If you have specified a recipient who is not you
              ...
              evidence of delivery and fulfilment by Peachmode and transfer of
              responsibility in the same way. <br />
            </p>
            <h3>Taxes and Duties</h3>
            <p align="justify">
              For Indian Customers, GST will be charged as specified. For
              international customers we send the package as a personal use item
              only but if the customs is applied for that country it needs to be
              paid by the customer and take the delivery for same. Company is
              not responsible for any Custom duties. The information about
              customs if applied will be informed to customer via email/phone.
            </p>
          </div>
        </div>
      </div>
