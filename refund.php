...
<html class="no-js" lang="en" dir="ltr">
  <head>
    ...
    <link rel="canonical" href="https://peachmode.com/policies/refund-policy" />
    ...
    <meta
      property="og:url"
      content="https://peachmode.com/policies/refund-policy"
    />
    ...
    <script id="__st">
      var __st = {
        a: 63748341981,
        offset: 19800,
        reqid: "6fd826a3-7b6a-47e4-b0e3-bbc65af28085",
        pageurl: "peachmode.com\/policies\/refund-policy",
        t: "prospect",
        u: "b7bdf58cb607",
      };
    </script>
    ...
    <div id="main" role="main" class="anchor">
      <div class="shopify-policy__container">
        ...
        <div class="shopify-policy__body">
          <div class="rte">
            <p align="justify">
              We believe in satisfying and delighting our customers. The product
              which we sell we belive that is the best customer can get at the
              price. Our return policy is made keeping our valuable customers in
              mind and hence we have easy transparent procedure for it. However
              we wish that you do not need to use the policy as far as possible
              but we do understand that under unforeseen conditions it is
              necessary to replace/return the product. Items which have reduced
              selling price are considered as sale items and which are sold at
              full price are considered non-sale (fresh) items. <br />
            </p>
            <h3></h3>
            <h3 align="justify">
              Item Received in Damaged Condition / Manufacturing Defect / Wrong
              Item Delivered: <br />
            </h3>
            <ul>
              <li>
                <p align="justify">
                  If you have received damaged product or the wrong item, please
                  mail us at<span> </span
                  ><a class="contact-info" href="mailto:returns@kalaajee.com"
                    >returns@kalaajee.com</a
                  ><span> </span>with your order number and couple of pictures
                  of the material within 7 Days of delivery.
                </p>
              </li>
              <li>
                <p>
                  We will try and replace the product as soon as possible or
                  refund the amount if you need.
                </p>
              </li>
              <li>
                <p align="justify">
                  At Kalaajee each product is quality checked, verified and then
                  shipped to the customer but we understand that manual errors
                  can happen and hence we offer to exchange the product or ship
                  a new piece.
                </p>
              </li>
              <li align="justify">
                <b
                  >Sale of clearance sale items as defined are final and will
                  not be exchanged.
                </b>
              </li>
            </ul>
            ...
            <ul>
              <li>
                <p align="justify">
                  We understand that in some cases that you may not like the
                  product which you have received or you feel that the product
                  is different from what was shown. There might be several
                  reasons for that. However we do have a flat 7 Day exchange /
                  return policy in such cases. It is applicable in case of non
                  clearance sale items.
                </p>
              </li>
              <li>
                <p align="justify">
                  Please mail at<span> </span
                  ><a class="contact-info" href="mailto:returns@kalaajee.com"
                    >returns@kalaajee.com</a
                  ><span> </span>with order number and reason for return.
                </p>
              </li>
              <li>
                <p align="justify">
                  We will get back to you with return packing slip and pickup
                  arrangements in 48-72 hours. (if the pickup is not available
                  at your pincode then please send the package back to us and we
                  will reimburse upto INR 100/- as the courier charges)
                </p>
              </li>
              <li>
                <p align="justify">
                  As soon as we receive the product in our warehouse you will
                  get store credit / gift card which can be used to purchase
                  anything else from the website.
                </p>
              </li>
              <li>
                <p align="justify">
              ...
              <li>
                <p align="justify">
                  We do add almost 100+ designs daily so we are sure that you
                  will be able to find a suitable item from our ever increasing
                  collection.
                </p>
              </li>
              <li>
              ...
              <li>
                <p align="justify">
                  Sale of clearance sale items are final and will not be
                  exchanged.
                </p>
              </li>
            </ul>
            <h3></h3>
            <h3 align="justify">
              Stitching Problems for International Customers: <br />
            </h3>
            <ul>
              <li>
                <p align="justify">
                  We at Kalaajee work with our tailoring team closely to provide
                  you the best fitted product. Although as you understand under
                  normal circumstances with your private tailor after many
                  alterations only perfect fit is possible.
                </p>
              </li>
              <li>
                <p align="justify">
                  We do recommend you to get the product stitched with your
                  private tailor for the best fit, however we understand in
                  certain international locations stitching is not possible or
                  it is very closely. Hence we provide this service at nominal
                  cost.
                </p>
              </li>
              <li>
                <p align="justify">
                  We recommend that when you select standard size you also put
                  the detailed sizing for the order in comments section which is
                  taken from your tailor. Standard sizing may not fit all and in
                  most cases alterations are required.
                </p>
              </li>
              <li>
                <p align="justify">
                  We can alter the product for you free of cost but you will
                  have to send the product at your own expense and we will alter
                  it and send it back to you. One side shipping charge company
                  will bear.
                </p>
              </li>
              <li>
                <p align="justify">
                  Please mail the details along with alterations needed on<span
                  > </span
                  ><a class="contact-info" href="mailto:returns@kalaajee.com"
                    >returns@kalaajee.com.</a
                  >
              ...
              <li>
                <p align="justify">
                  In any case stitched product won't be taken back and money
                  will not be refunded.
                </p>
              </li>
            </ul>
            <h3>Beads and Sequences coming off: <br /></h3>
            <ul>
              <li>
                <p align="justify">
                  We hope that people who buy product with beads and sequences
                  understand that it has tendency to come off. Even with good
                  handling and shipping this cannot be avoided. Most of such
                  problems can be avoided during stitching. Tailor can hide the
                  part which has less sequences or he can fix it all together.
                  Before returning the product please ask your tailor if it can
                  be adjusted. Even if we replace such items there are high
                  chances that you will receive similar product again.
                </p>
              </li>
            </ul>
          </div>
