...
<store-header sticky  class="header header--bordered " role="banner"><div class="top_wrapper hidden-phone" style="    background-color: #f7921c;">
  <div class="container">
    <div class="header__top_wrapper d-flex align-center justify-between">
      <div class="header__social_media"><ul class="social-media social-media--no-radius1 list--unstyled" role="list">
    <li class="social-media__item social-media__item--facebook">
      ...
      <a href="https://www.twitter.com/peachmode1" target="_blank" rel="noopener" class="social-media__link" aria-label="Follow us on Twitter"><svg focusable="false" width="20" height="16" class="icon icon--twitter   " viewBox="0 0 20 16">
  ...
  <ul class="header__linklist list--unstyled hidden-pocket hidden-lap" role="list"><li class="header__linklist-item has-dropdown" data-item-title="Collections">
        <a class="header__linklist-link link--animated" href="product.html" aria-controls="desktop-menu-1" aria-expanded="false">Collections</a><ul hidden id="desktop-menu-1" class="nav-dropdown  list--unstyled" role="list"><li class="nav-dropdown__item ">
                <a class="nav-dropdown__link link--faded" href="product.html" >New Arrivals</a></li><li class="nav-dropdown__item ">
                <a class="nav-dropdown__link link--faded" href="product.html" >Handbags</a></li><li class="nav-dropdown__item has-dropdown">
                <a class="nav-dropdown__link link--faded" href="product.html" aria-controls="desktop-menu-1-3" aria-expanded="false">Jewellery<svg focusable="false" width="7" height="10" class="icon icon--dropdown-arrow-right  icon--direction-aware " viewBox="0 0 7 10">
        <path fill-rule="evenodd" clip-rule="evenodd" d="M3.9394 5L0.469727 1.53033L1.53039 0.469666L6.06072 5L1.53039 9.53032L0.469727 8.46967L3.9394 5Z" fill="currentColor"></path>
      </svg>
</a><ul hidden id="desktop-menu-1-3" class="nav-dropdown list--unstyled" role="list"><li class="nav-dropdown__item">
                        <a class="nav-dropdown__link link--faded" href="product.html">Earrings</a>
                      </li><li class="nav-dropdown__item">
                        <a class="nav-dropdown__link link--faded" href="product.html">Necklace</a>
                      </li><li class="nav-dropdown__item">
                        <a class="nav-dropdown__link link--faded" href="product.html">Rings</a>
                      </li><li class="nav-dropdown__item">
                        <a class="nav-dropdown__link link--faded" href="product.html">Bracelet</a>
                      </li><li class="nav-dropdown__item">
                        <a class="nav-dropdown__link link--faded" href="product.html">Maang Tika</a>
                      </li></ul></li><li class="nav-dropdown__item ">
                <a class="nav-dropdown__link link--faded" href="product.html" >Bedsheets</a></li><li class="nav-dropdown__item ">
                <a class="nav-dropdown__link link--faded" href="product.html" >Exclusive</a></li><li class="nav-dropdown__item ">
                <a class="nav-dropdown__link link--faded" href="product.html" >Combo Packs</a></li><li class="nav-dropdown__item ">
                <a class="nav-dropdown__link link--faded" href="product.html" >Mens Kurta Pyjama</a></li></ul></li><li class="header__linklist-item has-dropdown" data-item-title="Sarees">
        <a class="header__linklist-link link--animated" href="product.html" aria-controls="desktop-menu-2" aria-expanded="false">Sarees</a><div hidden id="desktop-menu-2" class="mega-menu" >
              <div class="container">
                <div class="mega-menu__inner"><div class="mega-menu__columns-wrapper"><div class="mega-menu__column"><a href="product.html" class="mega-menu__title heading heading--small">Fabric</a><ul class="linklist list--unstyled" role="list"><li class="linklist__item">
                                  <a href="product.html" class="link--faded">Cotton Sarees</a>
                                </li><li class="linklist__item">
                                  <a href="product.html" class="link--faded">Art Silk Sarees</a>
                                </li><li class="linklist__item">
                                  <a href="product.html" class="link--faded">Chiffon Sarees</a>
                                </li><li class="linklist__item">
                                  <a href="product.html" class="link--faded">Georgette Sarees</a>
                                </li><li class="linklist__item">
                                  <a href="product.html" class="link--faded">Crepe Sarees</a>
                                </li><li class="linklist__item">
                                  <a href="product.html" class="link--faded">Organza Sarees</a>
                                </li><li class="linklist__item">
                                  <a href="product.html" class="link--faded">Chanderi Silk</a>
                                </li><li class="linklist__item">
                                  <a href="product.html" class="link--faded">Bhagalpuri Silk</a>
                                </li><li class="linklist__item">
                                  <a href="product.html" class="link--faded">Satin Sarees</a>
                                </li><li class="linklist__item">
                                  <a href="product.html" class="link--faded">Linen Sarees</a>
                                </li><li class="linklist__item">
                                  <a href="product.html" class="link--faded">Net Sarees</a>
                                </li><li class="linklist__item">
                                  <a href="product.html" class="link--faded">Kanjivaram</a>
                                </li><li class="linklist__item">
                                  <a href="product.html" class="link--faded">Banarasi Silk</a>
                                </li></ul></div><div class="mega-menu__column"><a href="product.html" class="mega-menu__title heading heading--small">Print/Pattern</a><ul class="linklist list--unstyled" role="list"><li class="linklist__item">
                                  <a href="product.html" class="link--faded">Floral Print</a>
                                </li><li class="linklist__item">
                                  <a href="product.html" class="link--faded">Bandhani Sarees</a>
                                </li><li class="linklist__item">
                                  <a href="product.html" class="link--faded">Embroidered</a>
                                </li><li class="linklist__item">
                                  <a href="product.html" class="link--faded">Paithani</a>
                                </li><li class="linklist__item">
                                  <a href="product.html" class="link--faded">Lucknowi / Chickankari</a>
                                </li><li class="linklist__item">
                                  <a href="product.html" class="link--faded">Patola</a>
                                </li></ul></div><div class="mega-menu__column"><a href="product.html" class="mega-menu__title heading heading--small">Collection</a><ul class="linklist list--unstyled" role="list"><li class="linklist__item">
                                  <a href="product.html" class="link--faded">Half N Half Saree</a>
                                </li><li class="linklist__item">
                                  <a href="product.html" class="link--faded">Authentic Drapes</a>
                                </li><li class="linklist__item">
                                  <a href="product.html" class="link--faded">Bollywood</a>
                                </li></ul></div><div class="mega-menu__column"><a href="product.html" class="mega-menu__title heading heading--small">Price</a><ul class="linklist list--unstyled" role="list"><li class="linklist__item">
                                  <a href="product.html" class="link--faded">0-999</a>
                                </li><li class="linklist__item">
                                  <a href="product.html" class="link--faded">1000-1999</a>
                                </li><li class="linklist__item">
                                  <a href="product.html" class="link--faded">2000-2999</a>
                                </li><li class="linklist__item">
                                  <a href="product.html" class="link--faded">3000-3999</a>
                                </li><li class="linklist__item">
                                  <a href="product.html" class="link--faded">4000-4999</a>
                                </li><li class="linklist__item">
                                  <a href="product.html" class="link--faded">5000 & above</a>
                                </li></ul></div><div class="mega-menu__column"><a href="product.html" class="mega-menu__title heading heading--small">Occasion</a><ul class="linklist list--unstyled" role="list"><li class="linklist__item">
                                  <a href="product.html" class="link--faded">Bridal</a>
                                </li><li class="linklist__item">
                                  <a href="product.html" class="link--faded">Casual / Daily</a>
                                </li><li class="linklist__item">
                                  <a href="product.html" class="link--faded">Engagement</a>
                                </li><li class="linklist__item">
                                  <a href="product.html" class="link--faded">Festive</a>
                                </li><li class="linklist__item">
                                  <a href="product.html" class="link--faded">Haldi</a>
                                </li><li class="linklist__item">
                                  <a href="product.html" class="link--faded">Mehendi</a>
                                </li><li class="linklist__item">
                                  <a href="product.html" class="link--faded">Office wear</a>
                                </li><li class="linklist__item">
                                  <a href="product.html" class="link--faded">Party </a>
                                </li><li class="linklist__item">
                                  <a href="product.html" class="link--faded">Reception</a>
                                </li><li class="linklist__item">
                                  <a href="product.html" class="link--faded">Sangeet</a>
                                </li><li class="linklist__item">
                                  <a href="product.html" class="link--faded">Wedding </a>
                                </li></ul></div><div class="mega-menu__column"><a href="product.html" class="mega-menu__title heading heading--small">Color</a><ul class="linklist list--unstyled" role="list"><li class="linklist__item">
                                  <a href="product.html" class="link--faded">Red</a>
                                </li><li class="linklist__item">
                                  <a href="product.html" class="link--faded">Pink</a>
                                </li><li class="linklist__item">
                                  <a href="product.html" class="link--faded">White</a>
                                </li><li class="linklist__item">
                                  <a href="product.html" class="link--faded">Black</a>
                                </li><li class="linklist__item">
                                  <a href="product.html" class="link--faded">Orange</a>
                                </li><li class="linklist__item">
                                  <a href="product.html" class="link--faded">Blue</a>
                                </li><li class="linklist__item">
                                  <a href="product.html" class="link--faded">Purple</a>
                                </li><li class="linklist__item">
                                  <a href="product.html" class="link--faded">Yellow</a>
                                </li><li class="linklist__item">
                                  <a href="product.html" class="link--faded">Brown</a>
                                </li><li class="linklist__item">
                                  <a href="product.html" class="link--faded">Grey</a>
                                </li><li class="linklist__item">
                                  <a href="product.html" class="link--faded">Green</a>
                                </li><li class="linklist__item">
                                  <a href="product.html" class="link--faded">Multicolor</a>
                                </li></ul></div></div><div class="mega-menu__images-wrapper "><div class="mega-menu__image-push image-zoom"><div class="mega-menu__image-wrapper">
                    <img loading="lazy" class="mega-menu__image" sizes="240px" height="459" width="277" alt="" src="//cdn.shopify.com/s/files/1/0637/4834/1981/files/Banner-10.jpg?v=1651132381" >
                  </div></div></div></div>
              </div>
            </div></li><li class="header__linklist-item has-dropdown" data-item-title="Salwar Suits">
        <a class="header__linklist-link link--animated" href="product.html" aria-controls="desktop-menu-3" aria-expanded="false">Salwar Suits</a><div hidden id="desktop-menu-3" class="mega-menu" >
              <div class="container">
                <div class="mega-menu__inner"><div class="mega-menu__columns-wrapper"><div class="mega-menu__column"><a href="product.html" class="mega-menu__title heading heading--small">Fabric</a><ul class="linklist list--unstyled" role="list"><li class="linklist__item">
                                  <a href="product.html" class="link--faded">Rayon</a>
                                </li><li class="linklist__item">
                                  <a href="product.html" class="link--faded">Cotton</a>
                                </li><li class="linklist__item">
                                  <a href="product.html" class="link--faded">Georgette</a>
                                </li><li class="linklist__item">
                                  <a href="product.html" class="link--faded">Crepe</a>
                                </li><li class="linklist__item">
                                  <a href="product.html" class="link--faded">Chiffon</a>
                                </li><li class="linklist__item">
                                  <a href="product.html" class="link--faded">Organza</a>
                                </li><li class="linklist__item">
                                  <a href="product.html" class="link--faded">Bhagalpuri Silk</a>
                                </li><li class="linklist__item">
                                  <a href="product.html" class="link--faded">Banarasi</a>
                                </li><li class="linklist__item">
                                  <a href="product.html" class="link--faded">Chanderi</a>
                                </li><li class="linklist__item">
                                  <a href="product.html" class="link--faded">Jacquard</a>
                                </li><li class="linklist__item">
                                  <a href="product.html" class="link--faded">Tapetta Silk</a>
                                </li><li class="linklist__item">
                                  <a href="product.html" class="link--faded">Tussar Silk</a>
                                </li><li class="linklist__item">
                                  <a href="product.html" class="link--faded">Net</a>
                                </li></ul></div><div class="mega-menu__column"><a href="product.html" class="mega-menu__title heading heading--small">Style</a><ul class="linklist list--unstyled" role="list"><li class="linklist__item">
                                  <a href="product.html" class="link--faded">Sharara Suits</a>
                                </li><li class="linklist__item">
                                  <a href="product.html" class="link--faded">Anarkali Suits</a>
                                </li><li class="linklist__item">
                                  <a href="product.html" class="link--faded">Palazzo Suits</a>
                                </li><li class="linklist__item">
                                  <a href="product.html" class="link--faded">Patiala Suits</a>
                                </li><li class="linklist__item">
                                  <a href="product.html" class="link--faded">Pakistani Suits</a>
                                </li><li class="linklist__item">
                                  <a href="product.html" class="link--faded">Straight Cut Suits</a>
                                </li><li class="linklist__item">
                                  <a href="product.html" class="link--faded">Indo western</a>
                                </li></ul></div><div class="mega-menu__column"><a href="product.html" class="mega-menu__title heading heading--small">Stitch Type</a><ul class="linklist list--unstyled" role="list"><li class="linklist__item">
                                  <a href="product.html" class="link--faded">Unstitched Salwar suits</a>
                                </li><li class="linklist__item">
                                  <a href="product.html" class="link--faded">Readymade Salwar suits</a>
                                </li><li class="linklist__item">
                                  <a href="product.html" class="link--faded">Semi Stitched</a>
                                </li></ul></div><div class="mega-menu__column"><a href="product.html" class="mega-menu__title heading heading--small">Price</a><ul class="linklist list--unstyled" role="list"><li class="linklist__item">
                                  <a href="product.html" class="link--faded">0-999</a>
                                </li><li class="linklist__item">
                                  <a href="product.html" class="link--faded">1000-1999</a>
                                  ...
                                  <a href="product.html" class="link--faded">3000 & above</a>
                                </li></ul></div><div class="mega-menu__column"><a href="product.html" class="mega-menu__title heading heading--small">Occasion</a><ul class="linklist list--unstyled" role="list"><li class="linklist__item">
                                  <a href="product.html" class="link--faded">Bridal</a>
                                </li><li class="linklist__item">
                                  <a href="product.html" class="link--faded">Casual / Daily</a>
                    ...
                    <img loading="lazy" class="mega-menu__image" sizes="240px" height="646" width="380" alt="" src="//cdn.shopify.com/s/files/1/0637/4834/1981/files/Banner-6.jpg?v=1651132202" >
                  </div></div></div></div>
              </div>
            </div></li><li class="header__linklist-item has-dropdown" data-item-title="Kurtis">
        <a class="header__linklist-link link--animated" href="product.html" aria-controls="desktop-menu-4" aria-expanded="false">Kurtis</a><div hidden id="desktop-menu-4" class="mega-menu" >
              <div class="container">
                <div class="mega-menu__inner"><div class="mega-menu__columns-wrapper"><div class="mega-menu__column"><a href="product.html" class="mega-menu__title heading heading--small">Fabric</a><ul class="linklist list--unstyled" role="list"><li class="linklist__item">
                                  <a href="product.html" class="link--faded">Silk</a>
                                </li><li class="linklist__item">
                                  <a href="product.html" class="link--faded">Rayon</a>
                                </li><li class="linklist__item">
                                  <a href="product.html" class="link--faded">Cotton</a>
                                  ...
                                  <a href="product.html" class="link--faded">Chanderi Cotton</a>
                                </li><li class="linklist__item">
                                  <a href="product.html" class="link--faded">Jacquard</a>
                                </li><li class="linklist__item">
                                  <a href="product.html" class="link--faded">Linen</a>
                                </li><li class="linklist__item">
                                  <a href="product.html" class="link--faded">Muslin</a>
                                </li></ul></div><div class="mega-menu__column"><a href="product.html" class="mega-menu__title heading heading--small">Print/Pattern</a><ul class="linklist list--unstyled" role="list"><li class="linklist__item">
                                  <a href="product.html" class="link--faded">Floral print</a>
                                </li><li class="linklist__item">
                                  <a href="product.html" class="link--faded">Solid</a>
                                </li><li class="linklist__item">
                                  <a href="product.html" class="link--faded">Bandhani</a>
                                </li><li class="linklist__item">
                                  <a href="product.html" class="link--faded">Printed</a>
                                </li><li class="linklist__item">
                                  <a href="product.html" class="link--faded">Embroidered</a>
                                </li><li class="linklist__item">
                                  <a href="product.html" class="link--faded">Anarkali</a>
                                </li><li class="linklist__item">
                                  <a href="product.html" class="link--faded">A-Line</a>
                                </li><li class="linklist__item">
                                  <a href="product.html" class="link--faded">Straight</a>
                                </li><li class="linklist__item">
                                  <a href="product.html" class="link--faded">Short </a>
                                </li><li class="linklist__item">
                                  <a href="product.html" class="link--faded">Long</a>
                                </li><li class="linklist__item">
                                  <a href="product.html" class="link--faded">High Low</a>
                                </li></ul></div><div class="mega-menu__column"><a href="product.html" class="mega-menu__title heading heading--small">Product Type</a><ul class="linklist list--unstyled" role="list"><li class="linklist__item">
                                  <a href="product.html" class="link--faded">Kurti Pant Set</a>
                                </li><li class="linklist__item">
                                  <a href="product.html" class="link--faded">Kurti Palazzo Set</a>
                                </li><li class="linklist__item">
                                  <a href="product.html" class="link--faded">Kurti Dhoti Set</a>
                                </li><li class="linklist__item">
                                  <a href="product.html" class="link--faded">Kurti Skirt Set</a>
                                </li><li class="linklist__item">
                                  <a href="product.html" class="link--faded">Palazzo Suit</a>
                                </li><li class="linklist__item">
                                  <a href="product.html" class="link--faded">Top Bottom Set</a>
                                </li><li class="linklist__item">
                                  <a href="product.html" class="link--faded">Kurti</a>
                                </li><li class="linklist__item">
                                  <a href="product.html" class="link--faded">Kaftan</a>
                                </li><li class="linklist__item">
                                  <a href="product.html" class="link--faded">Kaftan Set</a>
                                </li></ul></div><div class="mega-menu__column"><a href="product.html" class="mega-menu__title heading heading--small">Occasion</a><ul class="linklist list--unstyled" role="list"><li class="linklist__item">
                                  <a href="product.html" class="link--faded">Casual / Daily</a>
                                </li><li class="linklist__item">
                                  <a href="product.html" class="link--faded">Festive</a>
                                  ...
                                  <a href="product.html" class="link--faded">2000 & above</a>
                                </li></ul></div><div class="mega-menu__column"><a href="product.html" class="mega-menu__title heading heading--small">Color</a><ul class="linklist list--unstyled" role="list"><li class="linklist__item">
                                  <a href="product.html" class="link--faded">Red</a>
                                </li><li class="linklist__item">
                                  <a href="product.html" class="link--faded">Pink</a>
                    ...
                    <img loading="lazy" class="mega-menu__image" sizes="240px" height="459" width="277" alt="" src="//cdn.shopify.com/s/files/1/0637/4834/1981/files/Banner-9.jpg?v=1651132362" >
                  </div></div></div></div>
              </div>
            </div></li><li class="header__linklist-item has-dropdown" data-item-title="Lehengas">
        <a class="header__linklist-link link--animated" href="product.html" aria-controls="desktop-menu-5" aria-expanded="false">Lehengas</a><div hidden id="desktop-menu-5" class="mega-menu" >
              <div class="container">
                <div class="mega-menu__inner"><div class="mega-menu__columns-wrapper"><div class="mega-menu__column"><a href="product.html" class="mega-menu__title heading heading--small">Fabric</a><ul class="linklist list--unstyled" role="list"><li class="linklist__item">
                                  <a href="product.html" class="link--faded">Art Silk</a>
                                </li><li class="linklist__item">
                                  <a href="product.html" class="link--faded">Banarasi Silk</a>
                                </li><li class="linklist__item">
                                  <a href="product.html" class="link--faded">Cotton</a>
                                  ...
                                  <a href="product.html" class="link--faded">Satin</a>
                                </li><li class="linklist__item">
                                  <a href="product.html" class="link--faded">Silk</a>
                                </li><li class="linklist__item">
                                  <a href="product.html" class="link--faded">Velvet</a>
                                </li></ul></div><div class="mega-menu__column"><a href="product.html" class="mega-menu__title heading heading--small">Pattern</a><ul class="linklist list--unstyled" role="list"><li class="linklist__item">
                                  <a href="product.html" class="link--faded">Designer</a>
                                </li><li class="linklist__item">
                                  <a href="product.html" class="link--faded">Digital</a>
                                </li><li class="linklist__item">
                                  <a href="product.html" class="link--faded">Floral</a>
                                </li></ul></div><div class="mega-menu__column"><a href="product.html" class="mega-menu__title heading heading--small">Price</a><ul class="linklist list--unstyled" role="list"><li class="linklist__item">
                                  <a href="product.html" class="link--faded">0-999</a>
                                </li><li class="linklist__item">
                                  <a href="product.html" class="link--faded">1000-1999</a>
                                  ...
                                  <a href="product.html" class="link--faded">Gold</a>
                                </li><li class="linklist__item">
                                  <a href="product.html" class="link--faded">Grey</a>
                                </li><li class="linklist__item">
                                  <a href="product.html" class="link--faded">Green</a>
                                  ...
                                  <a href="product.html" class="link--faded">Ready to wear</a>
                                </li><li class="linklist__item">
                                  <a href="product.html" class="link--faded">Unstiched</a>
                                </li><li class="linklist__item">
                                  <a href="product.html" class="link--faded">Semi stitched</a>
                                </li></ul></div></div><div class="mega-menu__images-wrapper "><div class="mega-menu__image-push image-zoom"><div class="mega-menu__image-wrapper">
                    <img loading="lazy" class="mega-menu__image" sizes="240px" height="459" width="277" alt="" src="//cdn.shopify.com/s/files/1/0637/4834/1981/files/Banner-11.jpg?v=1651132400" >
                  </div></div></div></div>
              </div>
            </div></li><li class="header__linklist-item has-dropdown" data-item-title="Gowns">
        <a class="header__linklist-link link--animated" href="product.html" aria-controls="desktop-menu-6" aria-expanded="false">Gowns</a><div hidden id="desktop-menu-6" class="mega-menu" >
              <div class="container">
                <div class="mega-menu__inner"><div class="mega-menu__columns-wrapper"><div class="mega-menu__column"><a href="product.html" class="mega-menu__title heading heading--small">Fabric</a><ul class="linklist list--unstyled" role="list"><li class="linklist__item">
                                  <a href="product.html" class="link--faded">Cotton</a>
                                </li><li class="linklist__item">
            ...
            </div></li><li class="header__linklist-item has-dropdown" data-item-title="Western">
        <a class="header__linklist-link link--animated" href="product.html" aria-controls="desktop-menu-7" aria-expanded="false">Western</a><div hidden id="desktop-menu-7" class="mega-menu" >
              <div class="container">
                <div class="mega-menu__inner"><div class="mega-menu__columns-wrapper"><div class="mega-menu__column"><a href="product.html" class="mega-menu__title heading heading--small">Fabric</a><ul class="linklist list--unstyled" role="list"><li class="linklist__item">
                                  <a href="product.html" class="link--faded">Rayon</a>
                                </li><li class="linklist__item">
                                  ...
                                  <a href="product.html" class="link--faded">Crepe</a>
                                </li></ul></div><div class="mega-menu__column"><a href="product.html" class="mega-menu__title heading heading--small">Type</a><ul class="linklist list--unstyled" role="list"><li class="linklist__item">
                                  <a href="product.html" class="link--faded">Tops</a>
                                </li><li class="linklist__item">
                                  <a href="product.html" class="link--faded">Tunics</a>
                                </li><li class="linklist__item">
                                  <a href="product.html" class="link--faded">Dresses</a>
                                </li><li class="linklist__item">
                                  <a href="product.html" class="link--faded">Jumpsuit</a>
                                </li></ul></div><div class="mega-menu__column"><a href="product.html" class="mega-menu__title heading heading--small">Occasion</a><ul class="linklist list--unstyled" role="list"><li class="linklist__item">
                                  <a href="product.html" class="link--faded">Casual / Daily</a>
                                </li><li class="linklist__item">
                                  <a href="product.html" class="link--faded">Festive</a>
            ...
            </div></li><li class="header__linklist-item " data-item-title="Live">
        <a class="header__linklist-link link--animated" href="product.html" >Live</a></li><li class="header__linklist-item " data-item-title="Sale">
        <a class="header__linklist-link link--animated" href="product.html" >Sale</a></li></ul>
</desktop-navigation><div class="header__icon-list "><button is="toggle-button" class="header__icon-wrapper tap-area hidden-desk" aria-controls="mobile-menu-drawer" aria-expanded="false">
              <span class="visually-hidden">Navigation</span><svg focusable="false" width="18" height="14" class="icon icon--header-hamburger   " viewBox="0 0 18 14">
        <path d="M0 1h18M0 13h18H0zm0-6h18H0z" fill="none" stroke="currentColor" stroke-width="2"></path>
      </svg></button>
          <span class="st-mobile-icons"><div class="st-icons">
  <span class="st-search-icon" style="display: flex;">
    <svg focusable="false" width="18" height="25" class="icon icon&#45;&#45;header-search   " viewBox="0 0 18 18">
...
<script>
  ...
  function isDeviceMobile() {
    ...
    let stIcon = isDeviceMobile() ? document.querySelector('.st-mobile-icons .st-icons .st-search-icon'): document.querySelector('.st-desktop-icons .st-icons .st-search-icon');
    let stSearchBox = isDeviceMobile() ? document.querySelector('.st-mobile-searchbox') : document.querySelector('.st-search-box-desktop');
    let stCrossIcon = isDeviceMobile() ? document.querySelector('.st-mobile-icons .st-icons .st-search-close-btn') : document.querySelector('.st-search-box-desktop .st-icons .st-search-close-btn');
    let stSearchInput = isDeviceMobile() ? document.querySelector('.st-mobile-searchbox input') : document.querySelector('.st-search-box-desktop .st-search-input');
    ...
    if(stIcon){
      stIcon.addEventListener("click", function () {
        ...
        setTimeout(()=> {stSearchInput.focus()},500);
        
        let mobileFilterBar = document.querySelector('#mobile-filter-sort.sticky');
 ...
 <!-- LOGO PART --><h1 class="header__logo"><a class="header__logo-link" href="index.html"><span class="visually-hidden">Kalaajee</span>
      ...
      <div class="header__secondary-links">
        ...
        <path stroke="currentColor" fill="none" stroke-width="2" d="M1 1h18v14H1z"></path>
          ...
          <span class="st-desktop-icons"><div class="st-icons">
  <span class="st-search-icon" style="display: flex;">
    <svg focusable="false" width="18" height="25" class="icon icon&#45;&#45;header-search   " viewBox="0 0 18 18">
      <path d="M12.336 12.336c2.634-2.635 2.682-6.859.106-9.435-2.576-2.576-6.8-2.528-9.435.106C.373 5.642.325 9.866 2.901 12.442c2.576 2.576 6.8 2.528 9.435-.106zm0 0L17 17" fill="none" stroke="currentColor" stroke-width="2"></path>
    </svg>
...
<style>
  ...
  <div class="st-search-box-desktop">
    ...
    <span class="st-icon-search">
      <svg data-icon="search" viewBox="0 0 512 512" width="16px" height="16px">
        <path d="M495,466.2L377.2,348.4c29.2-35.6,46.8-81.2,46.8-130.9C424,103.5,331.5,11,217.5,11C103.4,11,11,103.5,11,217.5   S103.4,424,217.5,424c49.7,0,95.2-17.5,130.8-46.7L466.1,495c8,8,20.9,8,28.9,0C503,487.1,503,474.1,495,466.2z M217.5,382.9   C126.2,382.9,52,308.7,52,217.5S126.2,52,217.5,52C308.7,52,383,126.3,383,217.5S308.7,382.9,217.5,382.9z"></path>
      </svg>
    </span>

    <input class="st-search-input" name="st" autocomplete="off" placeholder="Search">
...
<a href="login.html" class="header__icon-wrapper tap-area hidden-phone hidden-desk" aria-label="Login"><svg focusable="false" width="18" height="17" class="icon icon--header-customer   " viewBox="0 0 18 17">
...
<div id="shopify-section-static-newsletter" class="shopify-section shopify-section--newsletter"></div><div id="shopify-section-static-text-with-icons" class="shopify-section shopify-section--text-with-icons"><style>
  ...
  <section class="section section--flush">
    <div class="section__color-wrapper" style="background-color:#f7921c;">
      ...
      </svg></div><div class="text-with-icons__content-wrapper"><p class="heading heading--small">Free shipping</p><p>Free shipping in India</p></div></native-carousel-item><native-carousel-item hidden id="block-static-text-with-icons-static-text-with-icons-1" class="text-with-icons__item" >
      ...
      </svg></div><div class="text-with-icons__content-wrapper"><p class="heading heading--small">Customer service</p><p>We are available from monday to saturday (9AM - 6PM) </p></div></native-carousel-item><native-carousel-item hidden id="block-static-text-with-icons-static-text-with-icons-2" class="text-with-icons__item" >
      ...
      </svg></div><div class="text-with-icons__content-wrapper"><p class="heading heading--small">Contact us</p><p>Need to contact us ? Just send us an e-mail at contact@peachmode.com</p></div></native-carousel-item></div><page-dots class="text-with-icons__dots dots-nav dots-nav--centered hidden-lap-and-up"><button class="dots-nav__item tap-area" aria-current="true">
...
<footer class="footer " style="background-color:#13becf;">
  <div class="container">
    <div class="footer__inner">
      <div class="footer__item-list"><div class="footer__item footer__item--links is-first" ><p class="footer__item-title heading heading--small hidden-phone">Quick Links</p>

                  <div class="footer__item-content  hidden-phone">
                    <ul class="linklist list--unstyled" role="list"><li class="linklist__item">
                          <a href="terms.html" class="link--faded">Terms & Condition</a>
                        </li><li class="linklist__item">
                          <a href="shipping.html" class="link--faded">Shipping & Delivery</a>
                        </li><li class="linklist__item">
                          <a href="good.html" class="link--faded">Goods & Services Tax</a>
                        </li><li class="linklist__item">
                          <a href="refund.html" class="link--faded">Refund and Cancellation</a>
                        </li><li class="linklist__item">
                          <a href="privacy.html" class="link--faded">Privacy Policies</a>
                        </li><li class="linklist__item">
         ...
         <div  id="block-footer-links" class="hidden-tablet-and-up" >
                <button is="toggle-button" id="product--reviews-pocket" class="collapsible-toggle heading heading--small hidden-lap-and-up anchor" aria-controls="block-footer-links-content" aria-expanded="false">
                  <span class="footer__item-title heading heading--small">Quick Links <svg focusable="false" width="12" height="8" class="icon icon--chevron   " viewBox="0 0 12 8">
        <path fill="none" d="M1 1l5 5 5-5" stroke="currentColor" stroke-width="2"></path>
      </svg></span>
                </button>
                ...
                <collapsible-content  id="block-footer-links-content" class="collapsible">
                  <div class="product-tabs__tab-item-content">
                    <div  class="spr-reviews" >
                     <ul class="linklist list--unstyled" role="list"><li class="linklist__item">
                          ...
                          <a href="reedem.html" class="link--faded">Reedem Gift Card</a>
                        </li><li class="linklist__item">
                          <a href="faq.html" class="link--faded">FAQs</a>
                        </li><li class="linklist__item">
                          <a href="contact.html" class="link--faded">Contact us</a>
              ...
              </div></div><div class="footer__item footer__item--links " ><p class="footer__item-title heading heading--small hidden-phone">Main menu</p>
                  ...
                  <div class="footer__item-content  hidden-phone">
                    <ul class="linklist list--unstyled" role="list"><li class="linklist__item">
                          ...
                          <a href="product.html" class="link--faded">Salwar Suits</a>
                        </li><li class="linklist__item">
         ...
         <div  id="block-footer-9efe0c55-78d1-4511-bd64-633f74e647ef" class="hidden-tablet-and-up" >
                <button is="toggle-button" id="product--reviews-pocket" class="collapsible-toggle heading heading--small hidden-lap-and-up anchor" aria-controls="block-footer-9efe0c55-78d1-4511-bd64-633f74e647ef-content" aria-expanded="false">
                  <span class="footer__item-title heading heading--small">Main menu <svg focusable="false" width="12" height="8" class="icon icon--chevron   " viewBox="0 0 12 8">
        <path fill="none" d="M1 1l5 5 5-5" stroke="currentColor" stroke-width="2"></path>
      </svg></span>
                </button>

                <collapsible-content  id="block-footer-9efe0c55-78d1-4511-bd64-633f74e647ef-content" class="collapsible">
                  <div class="product-tabs__tab-item-content">
                    <div  class="spr-reviews" >
                     <ul class="linklist list--unstyled" role="list"><li class="linklist__item">
                          ...
                          <a href="/collections/suits" class="link--faded">Salwar Suits</a>
                        </li><li class="linklist__item">
                          <a href="/collections/kurti" class="link--faded">Kurtis</a>
                        </li><li class="linklist__item">
                          ...
                          <a href="/pages/streams" class="link--faded">Live</a>
                        </li><li class="linklist__item">
                          <a href="/collections/sale" class="link--faded">Sale</a>
                        </li></ul>
                    </div>
              ...
              </div></div><div class="footer__item footer__item--links " ><p class="footer__item-title heading heading--small hidden-phone"></p>

                  <div class="footer__item-content  hidden-phone">
                    <ul class="linklist list--unstyled" role="list"></ul>
                  </div>
        
         <div  id="block-footer-c77bf3d3-c7a3-4763-9818-bf0f832abbd7" class="hidden-tablet-and-up" >
                <button is="toggle-button" id="product--reviews-pocket" class="collapsible-toggle heading heading--small hidden-lap-and-up anchor" aria-controls="block-footer-c77bf3d3-c7a3-4763-9818-bf0f832abbd7-content" aria-expanded="false">
                  <span class="footer__item-title heading heading--small">Information <svg focusable="false" width="12" height="8" class="icon icon--chevron   " viewBox="0 0 12 8">
        <path fill="none" d="M1 1l5 5 5-5" stroke="currentColor" stroke-width="2"></path>
      </svg></span>
                </button>

                <collapsible-content  id="block-footer-c77bf3d3-c7a3-4763-9818-bf0f832abbd7-content" class="collapsible">
                  <div class="product-tabs__tab-item-content">
                    <div  class="spr-reviews" >
                     <ul class="linklist list--unstyled" role="list"></ul>
                    </div>
              ...
              </div></div><div class="footer__item footer__item--social-media " ><p class="footer__item-title heading heading--small">Follow us</p><div class="footer__item-content footer__social">
                  <div><ul class="social-media social-media--no-radius1 list--unstyled" role="list">
    <li class="social-media__item social-media__item--facebook">
      <a href="https://www.facebook.com/peachmode1" target="_blank" rel="noopener" class="social-media__link" aria-label="Follow us on Facebook"><svg focusable="false" width="9" height="17" class="icon icon--facebook   " viewBox="0 0 9 17">
        <path fill-rule="evenodd" clip-rule="evenodd" d="M2.486 16.2084L2.486 8.81845H0L0 5.93845L2.486 5.93845L2.486 3.81845C2.38483 2.79982 2.73793 1.78841 3.45107 1.05407C4.16421 0.319722 5.16485 -0.0628415 6.186 0.00844868C6.9284 0.00408689 7.67039 0.0441585 8.408 0.128449V2.69845L6.883 2.69845C6.4898 2.61523 6.08104 2.73438 5.79414 3.01585C5.50724 3.29732 5.3803 3.70373 5.456 4.09845L5.456 5.93845H8.308L7.936 8.81845H5.46L5.46 16.2084H2.486Z" fill="currentColor"></path>
      </svg></a>
      ...
      <a href="https://www.youtube.com/c/Peachmode/" target="_blank" rel="noopener" class="social-media__link" aria-label="Follow us on YouTube"><svg fill="none" focusable="false" width="18" height="13" class="icon icon--youtube   " viewBox="0 0 18 13">
        <path fill-rule="evenodd" clip-rule="evenodd" d="M16.0325 0.369454C16.807 0.572743 17.4168 1.17173 17.6238 1.9324C18 3.31101 18 6.1875 18 6.1875C18 6.1875 18 9.06389 17.6238 10.4427C17.4168 11.2033 16.807 11.8023 16.0325 12.0056C14.6288 12.375 9 12.375 9 12.375C9 12.375 3.37122 12.375 1.96752 12.0056C1.19311 11.8023 0.583159 11.2033 0.376159 10.4427C0 9.06389 0 6.1875 0 6.1875C0 6.1875 0 3.31101 0.376159 1.9324C0.583159 1.17173 1.19311 0.572743 1.96752 0.369454C3.37122 0 9 0 9 0C9 0 14.6288 0 16.0325 0.369454ZM11.8636 6.1876L7.1591 8.79913V3.57588L11.8636 6.1876Z" fill="currentColor"></path>
                      ...
                      <div class="input">
                        ...
                        <label for="footer[contact][email]" class="input__label" style="background-color:#13becf;">Your e-mail</label>
                        <button type="submit" class="input__submit-icon tap-area" title="Register"><svg focusable="false" width="17" height="14" class="icon icon--nav-arrow-right  icon--direction-aware " viewBox="0 0 17 14">
        <path d="M0 7h15M9 1l6 6-6 6" stroke="currentColor" stroke-width="2" fill="none"></path>
      </svg></button>
                      </div></form></div></div></div>

      <div class="footer__aside"><span class="footer__copyright text--xsmall text--subdued">Copyright &copy; 2023 <a href="index.html">&nbsp; Kalaajee Fashions</a>. All rights reserved And Proudly Powered By<a href="https://www.successinnovativetechnologiespvtltd.com/"> &nbsp;Success Innovative Technologies Pvt. Ltd.</a></span><div class="footer__payment-methods">
